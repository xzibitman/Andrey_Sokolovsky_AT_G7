...
import homework.day9.playground.essence.creatures.Fly;
import homework.day9.playground.essence.creatures.Insect;
import homework.day9.playground.essence.creatures.Mosquito;
import homework.day9.playground.processors.FlyableProcessor;
...
public class FlyableProcessorRunner {
    public static void main(String[] args) {
       ...
       // Flyable flyablePlane = new Plane(3452, "Boeing 837 Flyable");  There is no class Plane
       ...
       // Aircraft aircraftPlane = new Plane(3452, "Boeing 837 Aircraft"); There is no class Plane
      ...
      //  Plane aPlane = new Plane(3452, "Boeing 837 Plane");              There is no class Plane
      ...
      //  flyableProcessor.runFlyable(aircraftPlane);
       ...
       // flyableProcessor.runFlyable(aPlane);
        ...
        flyableProcessor.runFlyable(flyableCopter, "вникуда");
