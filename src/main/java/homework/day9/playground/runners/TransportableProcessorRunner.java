...
import homework.day9.playground.processors.TransportableProcessor;
...
public class TransportableProcessorRunner {
    public static void main(String[] args) {
        ...
        // Transportable transportablePlane = new Plane(3452, "Airbus a380 Transportable"); There is no class
        ...
        transportableProcessor.runTransportable(transportableCopter, 24, 242);
        transportableProcessor.runTransportable(transportableMoped, 93, 7);
